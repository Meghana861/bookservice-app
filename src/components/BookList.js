  ...
  return (
    <div>
       <h2> List of Books</h2>
        ...
        <div>
            <label>Author</label>
            <input typr="text" value={updatedAuthor} onChange={(e)=>setUpdatedAuthor(e.target.value)}/>
        </div>
        <div>
            <label>Price</label>
            <input typr="text" value={updatedPrice} onChange={(e)=>setUpdatedPrice(e.target.value)}/>
        </div>
        <div>
            <label>PubDate</label>
            <input typr="text" value={updatedpubDate} onChange={(e)=>setUpdatedPubDate(e.target.value)}/>
        </div>
